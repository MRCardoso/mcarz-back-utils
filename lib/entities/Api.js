...
var Api = /** @class */ (function () {
    ...
    */
     ...
     * @returns {Promise}
     */
    Api.prototype.add = function (post, rules, next, middleware) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            next().then(function (logged) {
                var _a = middleware(logged), token = _a.token, expires = _a.expires, payload = _a.payload;
                ...
                if (!_this.validateFields(post, rules)) {
                    return reject(Utils_1.is400(_this._validator.getErrors()));
                }
                _this._model
                    .save(post)
    ...
    Api.prototype.removeByToken = function (token) {
        ...
        if (!this.validateToken(params)) {
            return Promise.reject(Utils_1.is400(this._validator.getErrors()));
        }
     ...
     * @returns {Promise}
     */
    Api.prototype.getByToken = function (next, token) {
        var _a;
        var params = (_a = {}, _a[this._tokenField] = token, _a);
        if (!this.validateToken(params)) {
            return Promise.reject(Utils_1.is400(this._validator.getErrors()));

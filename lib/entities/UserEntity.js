...
var UserEntity = /** @class */ (function (_super) {
    ...
    function UserEntity(app, envConfig) {
        var _this = this;
    ...
    */
     ...
     * @returns {Promise}
     */
    UserEntity.prototype.updateResetToken = function (id) {
        var _this = this;
        var _a = this.envConfig.resetToken, resetToken = _a === void 0 ? (60 * 60 * 1000) : _a;
        var password = UserEntity.hashPassword(Date.now() * 1000);
        var token = crypto_1.randomBytes(32).toString('hex');
        var expires = Date.now() + resetToken;
        return new Promise(function (resolve, reject) {
            var _a;
            _this.id = id;
